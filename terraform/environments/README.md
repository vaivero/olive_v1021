...
These additional environments will run on shared infrastructure, named `service` by default, unless you have specified otherwise. However, each environment has its own data and its own Kubernetes namespace.
